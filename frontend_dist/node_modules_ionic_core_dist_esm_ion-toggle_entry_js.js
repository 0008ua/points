...
/* harmony import */ var _dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dir-e8b767a8.js */ 5094);
...
/* harmony import */ var _capacitor_6d1861b7_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./capacitor-6d1861b7.js */ 3958);
...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.setupGesture = /*#__PURE__*/(0,C_it_points_points_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.toggleChecked();
      (0,_haptic_d85b8584_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
