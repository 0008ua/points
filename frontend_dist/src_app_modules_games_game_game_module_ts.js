...
let GamePage = (_class = class GamePage {
  ...
  ngOnInit() {
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_13__.combineLatest)([this.gameType$, this.rounds$]).subscribe(([gameType, rounds]) => {
      ...
      this.showToolbarMenu = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.games[gameType].showToolbarMenu;
      this.roundsCfg = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.games[gameType].rounds;
      if (gameType === 'uno') {
