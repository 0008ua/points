...
const Button = class {
  ...
  connectedCallback() {
    ...
    if (this.type !== 'button' && (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_1__.n)(this.el)) {
    ...
    if (typeof form === 'string') {
      ...
      if (el) {
        if (el instanceof HTMLFormElement) {
           ...
           */
          (0,_index_e86f0117_js__WEBPACK_IMPORTED_MODULE_2__.p)(`Form with selector: "#${form}" could not be found. Verify that the id is attached to a <form> element.`, this.el);
          return null;
        }
      } else {
        /**
         ...
         */
        (0,_index_e86f0117_js__WEBPACK_IMPORTED_MODULE_2__.p)(`Form with selector: "#${form}" could not be found. Verify that the id is correct and the form is rendered in the DOM.`, this.el);
        return null;
      }
    }
    if (form !== undefined) {
       ...
       */
      (0,_index_e86f0117_js__WEBPACK_IMPORTED_MODULE_2__.p)(`The provided "form" element is invalid. Verify that the form is a HTMLFormElement and rendered in the DOM.`, this.el);
      return null;
    }
    /**
