...
const Card = class {
  ...
  componentWillLoad() {
    this.inheritedAriaAttributes = (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_1__.k)(this.el, ['aria-label']);
  }
  isClickable() {
  ...
  renderCard(mode) {
    ...
    if (!clickable) {
      return [(0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)];
    }
    const {
      href,
      routerAnimation,
    ...
    return (0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_0__.h)(TagType, Object.assign({}, attrs, inheritedAriaAttributes, {
      class: "card-native",
      part: "native",
      disabled: this.disabled,
      onClick: ev => (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_2__.o)(href, ev, routerDirection, routerAnimation)
    }), (0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null), clickable && mode === 'md' && (0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", null));
  }
  render() {
