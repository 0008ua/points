...
/* harmony import */ var _input_utils_4c00ca72_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./input.utils-4c00ca72.js */ 4083);
...
/* harmony import */ var _ionic_global_a9abd569_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ionic-global-a9abd569.js */ 4771);
...
const Input = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign(Object.assign({}, (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el)), (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.k)(this.el, ['tabindex', 'title', 'data-form-type']));
  }
  connectedCallback() {
    const {
      el
    } = this;
    this.legacyFormController = (0,_form_controller_6cd7ebd1_js__WEBPACK_IMPORTED_MODULE_2__.c)(el);
    this.slotMutationController = (0,_input_utils_4c00ca72_js__WEBPACK_IMPORTED_MODULE_6__.c)(el, 'label', () => (0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_1__.i)(this));
    this.notchController = (0,_notch_controller_cfcb8c01_js__WEBPACK_IMPORTED_MODULE_3__.c)(el, () => this.notchSpacerEl, () => this.labelSlot);
    this.emitStyle();
  ...
  renderCounter() {
    ...
    return (0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "counter"
    }, (0,_input_utils_4c00ca72_js__WEBPACK_IMPORTED_MODULE_6__.g)(value, maxlength, counterFormatter));
  }
  /**
  ...
  renderInput() {
    ...
    return (0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      "aria-hidden": "true",
      icon: mode === 'ios' ? _index_393bc14a_js__WEBPACK_IMPORTED_MODULE_8__.b : _index_393bc14a_js__WEBPACK_IMPORTED_MODULE_8__.d
  ...
  renderLegacyInput() {
    if (!this.hasLoggedDeprecationWarning) {
      (0,_index_e86f0117_js__WEBPACK_IMPORTED_MODULE_5__.p)(`ion-input now requires providing a label with either the "label" property or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the "label" property or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
      if (this.legacy) {
        (0,_index_e86f0117_js__WEBPACK_IMPORTED_MODULE_5__.p)(`ion-input is being used with the "legacy" property enabled which will forcibly enable the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new input syntax.`, this.el);
    ...
    const label = (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.h)(this.el);
    if (label) {
      label.id = labelId;
    }
    return (0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_1__.H, {
